...
<div className='w-full h-[100vh] flex flex-col'>
 <div className='w-full h-[100px] bg-[#f5d802] rounded-b-[30px] shadow-gray-400 shadow-md flex items-center gap-3'>
      ...
      <div className='w-full h-[550px] flex flex-col py-[30px] px-[20px] overflow-auto gap-2'>
       {showPicker &&
      ...
      {selectedUser && <div className='w-full lg:w-[70%] h-[100px] fixed bottom-[20px] flex items-center justify-center'>
       ...
       <img src={frontendImg} alt="" className='w-[100px] absolute bottom-[100px] right-[10%] rounded-lg shadow-gray-400 shadow-md' />
        <form className='w-[95%] lg:w-[70%]: h-[60px] bg-[#f5d802] shadow-gray-400 shadow-md rounded-full px-[20px] flex items-center gap-[10px]' onSubmit={handleSendMessage}>
